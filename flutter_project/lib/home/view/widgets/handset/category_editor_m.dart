...
class CategoryEditorM extends StatelessWidget {
  const CategoryEditorM(this.category,{ Key? key }) : super(key: key);
  final Category category;

  @override
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => CategoryEditorCubit(RepositoryProvider.of<NivedhanamRepository>(context)),
    child: CategoryEditorDialogueM(category),
    );
  }
}

class CategoryEditorDialogueM extends StatefulWidget {
  const CategoryEditorDialogueM(this.category, { Key? key }) : super(key: key);
  final Category category;

  @override
  _CategoryEditorDialogueMState createState() => _CategoryEditorDialogueMState();
}

class _CategoryEditorDialogueMState extends State<CategoryEditorDialogueM> {
